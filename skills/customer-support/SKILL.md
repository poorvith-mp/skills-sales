...
- [references/response-templates.md](references/response-templates.md) — Ready-to-adapt templates for common scenarios (refunds, bugs, feature requests, outages, billing)
- [references/escalation-guide.md](references/escalation-guide.md) — Escalation criteria, internal routing, SLA expectations, and handoff protocols
## Core Principles
